import { COMMON_SELECTORS, hyphenize } from "@bigbinary/neeto-playwright-commons";
...
test.describe("Add new View", () => {
    ...
    test("should create a new view", async ({ page, ticketPage, neetoPlaywrightUtilities }) => {
        ...
        await test.step("Step 4: Add new view, Filling view name and desc", async () => {
        ...
        await test.step("Step 5: Toggling automation rule", async () => {
        ...
        await test.step("Step 6: Setting up conditions", async () => {
        ...
        await test.step("Step 7: Verify add condition button", async () => {
        ...
        await test.step("Step 8: Verify delete condition button", async () => {
        ...
        await test.step("Step 9: Verify preview ", async () => {
        ...
        await test.step("Step 10: Setting sort order ", async () => {
        ...
        await test.step("Step 11: Setting availability", () =>
        ...
        await test.step("Step 12: Submitting and verifying view in the table", async () => {
        ...
        await test.step("Step 12: Asserting the visibility of new view in tickets", async () => {
            await page.getByTestId(VIEW_SELECTORS.settingsNavTab).click();
            await neetoPlaywrightUtilities.waitForPageLoad();
            await page.getByTestId(TICKET_BUTTON_SELECTORS.ticketsNavTab).click();
            const newViewButton = page.getByTestId(`${hyphenize(viewInfo.name)}-sub-link`);
        ...
        await test.step("Step 13: Teardown view", async () => {
            await page.getByTestId(VIEW_SELECTORS.settingsNavTab).click();
            await neetoPlaywrightUtilities.waitForPageLoad();
    ...
    test("should not create a new view without required fields", async ({ page, neetoPlaywrightUtilities, viewPage }) => {
        await test.step("Step 1: Navigate to home page", () =>
            page.goto("/"));
